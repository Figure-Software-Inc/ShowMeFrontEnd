...
const IPhone1313Pro3 = () => {
  return (
    <View style={styles.iphone1313Pro3}>
      ...
      />
      <View style={styles.iphone1313Pro3Child} />
      ...
      <View style={[styles.iphone1313Pro3Item, styles.iphone1313Layout]} />
      <View style={[styles.iphone1313Pro3Inner, styles.iphone1313Layout]} />
      ...
      <View
        style={[styles.iphone1313Pro3Child1, styles.iphone1313ChildLayout]}
      />
      <View
        style={[styles.iphone1313Pro3Child2, styles.iphone1313ChildLayout]}
      />
      <Image
...
const styles = StyleSheet.create({
  ...
  iphone1313Pro3Child1: {
    top: 684,
  },
  iphone1313Pro3Child2: {
    top: 621,
  },
  vectorIcon1: {
    height: "2.49%",
